import{An as gE,Cr as pS,Dn as fN,Fn as hN,G as Kc,Hr as tv,I as He,Jn as kh,Lt as Vr,N as Gc,Q as Ma,Qn as lI,Rt as Wc,Vr as ts,Wr as uE,Yr as ve,a as AN,at as Nh,bi as zN,bt as Qn,gt as QA,it as NN,j as Fs,kn as g9,lt as ON,nt as N9,pi as y,pt as Ph,qn as ke,qt as Yi,ri as wc,rt as NE,v as Dg,vr as p,wt as Re,xt as Qt,zn as iE,zr as tE}from"./chunk-aZK1wy9b.js";import{A as m,L as w,S as _r,a as Dr,i as Cr}from"./chunk-Cztuz5N1.js";var Y=[`switch`];var J=[`*`];function K(i,p){i&1&&(wc(0,`span`,11),tv(),wc(1,`svg`,13),Gc(2,`path`,14),Nh(),wc(3,`svg`,15),Gc(4,`path`,16),Nh()())}var ee=new y(`mat-slide-toggle-default-options`,{providedIn:`root`,factory:()=>({disableToggleValue:!1,hideIcon:!1,disabledInteractive:!1})});var g=class{source;checked;constructor(p,t){this.source=p,this.checked=t}};var te=(()=>{class i{_elementRef=p(Re);_focusMonitor=p(lI);_changeDetectorRef=p(Vr);defaults=p(ee);_onChange=t=>{};_onTouched=()=>{};_validatorOnChange=()=>{};_uniqueId;_checked=!1;_createChangeEvent(t){return new g(this,t)}_labelId;get buttonId(){return`${this.id||this._uniqueId}-button`}_switchElement;focus(){this._switchElement.nativeElement.focus()}_noopAnimations=N9();_focused=!1;name=null;id;labelPosition=`after`;ariaLabel=null;ariaLabelledby=null;ariaDescribedby;required=!1;color;disabled=!1;fullWidth=!1;disableRipple=!1;tabIndex=0;get checked(){return this._checked}set checked(t){this._checked=t,this._changeDetectorRef.markForCheck()}hideIcon;disabledInteractive;change=new ve;toggleChange=new ve;get inputId(){return`${this.id||this._uniqueId}-input`}constructor(){p(Fs).load(Cr);let t=p(new Kc(`tabindex`),{optional:!0}),a=this.defaults;this.tabIndex=t==null?0:parseInt(t)||0,this.color=a.color||`accent`,this.id=this._uniqueId=p(Dg).getId(`mat-mdc-slide-toggle-`),this.hideIcon=a.hideIcon??!1,this.disabledInteractive=a.disabledInteractive??!1,this._labelId=this._uniqueId+`-label`}ngAfterContentInit(){this._focusMonitor.monitor(this._elementRef,!0).subscribe(t=>{t===`keyboard`||t===`program`?(this._focused=!0,this._changeDetectorRef.markForCheck()):t||Promise.resolve().then(()=>{this._focused=!1,this._onTouched(),this._changeDetectorRef.markForCheck()})})}ngOnChanges(t){t.required&&this._validatorOnChange()}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef)}writeValue(t){this.checked=!!t}registerOnChange(t){this._onChange=t}registerOnTouched(t){this._onTouched=t}validate(t){return this.required&&t.value!==!0?{required:!0}:null}registerOnValidatorChange(t){this._validatorOnChange=t}setDisabledState(t){this.disabled=t,this._changeDetectorRef.markForCheck()}toggle(){this.checked=!this.checked,this._onChange(this.checked)}_emitChangeEvent(){this._onChange(this.checked),this.change.emit(this._createChangeEvent(this.checked))}_handleClick(){this.disabled||(this.toggleChange.emit(),this.defaults.disableToggleValue||(this.checked=!this.checked,this._onChange(this.checked),this.change.emit(new g(this,this.checked))))}_getAriaLabelledBy(){return this.ariaLabelledby?this.ariaLabelledby:this.ariaLabel?null:this._labelId}static ɵfac=function(a){return new(a||i)};static ɵcmp=Yi({type:i,selectors:[[`mat-slide-toggle`]],viewQuery:function(a,e){if(a&1&&uE(Y,5),a&2){let l;kh(l=Ph())&&(e._switchElement=l.first)}},hostAttrs:[1,`mat-mdc-slide-toggle`],hostVars:15,hostBindings:function(a,e){a&2&&(iE(`id`,e.id),ts(`tabindex`,null)(`aria-label`,null)(`name`,null)(`aria-labelledby`,null),zN(e.color?`mat-`+e.color:``),gE(`mat-mdc-slide-toggle-focused`,e._focused)(`mat-mdc-slide-toggle-checked`,e.checked)(`mat-slide-toggle-full-width`,e.fullWidth)(`_mat-animation-noopable`,e._noopAnimations))},inputs:{name:`name`,id:`id`,labelPosition:`labelPosition`,ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],required:[2,`required`,`required`,Qn],color:`color`,disabled:[2,`disabled`,`disabled`,Qn],fullWidth:[2,`fullWidth`,`fullWidth`,Qn],disableRipple:[2,`disableRipple`,`disableRipple`,Qn],tabIndex:[2,`tabIndex`,`tabIndex`,t=>t==null?0:QA(t)],checked:[2,`checked`,`checked`,Qn],hideIcon:[2,`hideIcon`,`hideIcon`,Qn],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,Qn]},outputs:{change:`change`,toggleChange:`toggleChange`},exportAs:[`matSlideToggle`],features:[NE([{provide:w,useExisting:Ma(()=>i),multi:!0},{provide:m,useExisting:i,multi:!0}]),Qt],ngContentSelectors:J,decls:14,vars:27,consts:[[`switch`,``],[`mat-internal-form-field`,``,3,`labelPosition`],[`role`,`switch`,`type`,`button`,1,`mdc-switch`,3,`click`,`tabIndex`,`disabled`],[1,`mat-mdc-slide-toggle-touch-target`],[1,`mdc-switch__track`],[1,`mdc-switch__handle-track`],[1,`mdc-switch__handle`],[1,`mdc-switch__shadow`],[1,`mdc-elevation-overlay`],[1,`mdc-switch__ripple`],[`mat-ripple`,``,1,`mat-mdc-slide-toggle-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mdc-switch__icons`],[1,`mdc-label`,3,`click`,`for`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--on`],[`d`,`M19.69,5.23L8.96,15.96l-4.23-4.23L2.96,13.5l6,6L21.46,7L19.69,5.23z`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--off`],[`d`,`M20 13H4v-2h16v2z`]],template:function(a,e){if(a&1&&(NN(),wc(0,`div`,1)(1,`button`,2,0),Wc(`click`,function(){return e._handleClick()}),Gc(3,`div`,3)(4,`span`,4),wc(5,`span`,5)(6,`span`,6)(7,`span`,7),Gc(8,`span`,8),Nh(),wc(9,`span`,9),Gc(10,`span`,10),Nh(),fN(11,K,5,0,`span`,11),Nh()()(),wc(12,`label`,12),Wc(`click`,function($){return $.stopPropagation()}),AN(13),Nh()()),a&2){let l=ON(2);tE(`labelPosition`,e.labelPosition),pS(),gE(`mdc-switch--selected`,e.checked)(`mdc-switch--unselected`,!e.checked)(`mdc-switch--checked`,e.checked)(`mdc-switch--disabled`,e.disabled)(`mat-mdc-slide-toggle-disabled-interactive`,e.disabledInteractive),tE(`tabIndex`,e.disabled&&!e.disabledInteractive?-1:e.tabIndex)(`disabled`,e.disabled&&!e.disabledInteractive),ts(`id`,e.buttonId)(`name`,e.name)(`aria-label`,e.ariaLabel)(`aria-labelledby`,e._getAriaLabelledBy())(`aria-describedby`,e.ariaDescribedby)(`aria-required`,e.required||null)(`aria-checked`,e.checked)(`aria-disabled`,e.disabled&&e.disabledInteractive?`true`:null),pS(9),tE(`matRippleTrigger`,l)(`matRippleDisabled`,e.disableRipple||e.disabled)(`matRippleCentered`,!0),pS(),hN(e.hideIcon?-1:11),pS(),tE(`for`,e.buttonId),ts(`id`,e._labelId)}},dependencies:[_r,Dr],styles:[`.mdc-switch {
  align-items: center;
  background: none;
  border: none;
  cursor: pointer;
...
`],encapsulation:2})}return i})();var we=(()=>{class i{static ɵfac=function(a){return new(a||i)};static ɵmod=He({type:i});static ɵinj=ke({imports:[te,g9]})}return i})();export{we as n,te as t};