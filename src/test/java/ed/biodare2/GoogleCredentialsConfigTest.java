...
@SpringJUnitConfig
@ContextConfiguration(classes = {GoogleCredentialsConfigTest.TestConfig.class})
public class GoogleCredentialsConfigTest {
    ...
    @Test
    public void testGoogleCredentialsBean() throws IOException {
        assertNotNull(googleCredentials, "GoogleCredentials bean should not be null");
    }
